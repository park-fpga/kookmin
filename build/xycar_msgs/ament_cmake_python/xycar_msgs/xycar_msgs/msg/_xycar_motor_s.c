...
bool xycar_msgs__msg__xycar_motor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xycar_msgs.msg._xycar_motor.XycarMotor", full_classname_dest, 38) == 0);
  }
  xycar_msgs__msg__XycarMotor * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of XycarMotor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xycar_msgs.msg._xycar_motor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "XycarMotor");
