...
static const _XycarMotor_type_support_symbol_names_t _XycarMotor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xycar_msgs, msg, XycarMotor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, xycar_msgs, msg, XycarMotor)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, xycar_msgs, msg, XycarMotor)() {
  return &::xycar_msgs::msg::rosidl_typesupport_c::XycarMotor_message_type_support_handle;
}
