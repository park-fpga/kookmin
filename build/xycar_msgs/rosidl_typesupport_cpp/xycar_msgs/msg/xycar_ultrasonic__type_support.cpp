...
static const _XycarUltrasonic_type_support_symbol_names_t _XycarUltrasonic_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xycar_msgs, msg, XycarUltrasonic)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xycar_msgs, msg, XycarUltrasonic)),
  }
};
...
{
  return &::xycar_msgs::msg::rosidl_typesupport_cpp::XycarUltrasonic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xycar_msgs, msg, XycarUltrasonic)() {
  return get_message_type_support_handle<xycar_msgs::msg::XycarUltrasonic>();
}
